...
// Acepta cualquier formato común de URL de Google Drive y devuelve la URL embebible (/preview).
function parseDriveUrl(url: string | undefined | null): string | null {
...
export function TabataTimer({
  ...
  // ── Info modal (descripción + video del normativo) ──
  // Flow: tap "?" → confirm pausa → info modal
  const [infoConfirmFor, setInfoConfirmFor] = useState<TabataExercise | null>(null);
  ...
  const currentExercise = hasActiveExercises
    ? activeExercises[currentExerciseIndex]
    : null;
  ...
  const nextDifferentExercise = useMemo(() => {
    if (!hasActiveExercises || !currentExercise) return null;
    ...
    for (let i = currentExerciseIndex + 1; i < activeExercises.length; i++) {
      ...
      if (exBase !== currentBase) return { exercise: ex, flatIndex: i };
    }
    return null;
  ...
  const exerciseGroups = useMemo(() => {
    type Group = {
      baseId: string;
      baseName: string;
      exercises: { ex: TabataExercise; originalIndex: number }[];
    };
    const groups: Group[] = [];
  ...
  const overallProgress = (() => {
    ...
    if (isBlockMode) {
      ...
      for (let i = 0; i < currentBlockIndex; i++) {
        ...
        currentRound - 1 + (phase === "rest" || phase === "blockRest" ? 1 : 0);
    ...
    for (let i = 0; i < currentExerciseIndex; i++) {
      ...
      currentRound -
      1 +
      (phase === "rest" || phase === "intensityRest" ? 1 : 0);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {currentExercise && isTimerActive && (
          <TabataExerciseInfo
            ...
            onShowInfo={(ex) => setInfoConfirmFor(ex)}
          />
        )}
              ...
              return (
                ...
                >
                  ...
                  {isMulti && (
                    <div
                      style={{
                        ...
                        padding: "6px 10px",
                        background:
                          "color-mix(in srgb, var(--gold-dark) 8%, var(--card))",
                  ...
                  {group.exercises.map(({ ex, originalIndex }, subIdx) => {
                    const gc =
                      CAT_COLORS[ex.category] || "var(--muted-foreground)";
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          borderBottom:
                            isMulti && subIdx < group.exercises.length - 1
          ...
          >
            {isBlockMode ? (
              ...
              <>
                ...
                />
                {/* Sound config below blocks (work/rest/rounds live in blocks) */}
        ...
        {phase === "idle" && disabledExercises.length > 0 && (
          <div
            ...
            style={{
              ...
              border:
                "1px solid color-mix(in srgb, var(--orange) 30%, var(--border))",
              borderRadius: 8,
              flexShrink: 0,
            }}
          >
            ...
            >
              {disabledExercises.length} ejercicio
              {disabledExercises.length > 1 ? "s" : ""} oculto
              {disabledExercises.length > 1 ? "s" : ""}
            </span>
          </div>
        )}
        ...
        <div
          style={{
            padding: phase === "idle" ? "8px 16px 0" : "0",
            flexShrink: 0,
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
        ...
        >
          {/* ── Active timer: [Prev] [Timer ring] [Next] ── */}
          {isTimerActive && (
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <TabataDisplay
                ...
                currentBlockIndex={
                  isBlockMode ? currentBlockIndex : undefined
                }
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                background: "none",
                border:
                  "1px solid color-mix(in srgb, var(--orange) 40%, var(--border))",
                borderRadius: 8,
                color: "var(--orange)",
                fontSize: 11,
                fontWeight: 700,
              ...
              onPointerEnter={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background =
                  "color-mix(in srgb, var(--orange) 10%, var(--card))";
              }}
              onPointerLeave={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background =
                  "none";
      ...
      {/* ── Ticker board exercise list modal ── */}
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "36px 1fr 54px 54px 58px",
              ...
              >
                {["#", "EJERCICIO", "SERIES", "REPS", "KG"].map((h) => (
                  <div
                    key={h}
                    style={{
                      fontFamily: "var(--font-display)",
                      ...
                      letterSpacing: ".1em",
                      color: "var(--muted-foreground)",
                      textAlign: h === "#" || h === "EJERCICIO" ? "left" : "center",
                      padding: "0 4px",
                    }}
                  >
                    {h}
              ...
              <div style={{ padding: "4px 12px 20px" }}>
                {activeExercises.map((ex, flatIdx) => {
                  const isDone =
                    phase === "finished" ||
                    flatIdx < currentExerciseIndex ||
                    (flatIdx === currentExerciseIndex &&
                      phase === "exerciseComplete");
                  const isCurrent =
                    flatIdx === currentExerciseIndex &&
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: isCurrent
                          ...
                          : "transparent",
                        opacity: isDone ? 0.35 : isFuture ? 0.6 : 1,
                        transition: "all .3s",
                        borderBottom: "1px solid var(--border)",
                      }}
                    >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Se perderá todo el progreso actual del cronómetro. ¿Estás
                seguro?
              </div>
            </div>
            <div
      ...
      {infoConfirmFor && (
        <div
          ...
          onClick={() => setInfoConfirmFor(null)}
        >
          <div
            style={{
              width: "100%",
          ...
          >
            <div style={{ padding: "20px 20px 12px", textAlign: "center" }}>
              ...
              >
                Vas a abrir la descripción y el video. ¿Querés pausar el
                cronómetro mientras tanto?
              </div>
            </div>
            <div
              style={{
            ...
            >
              <button
                ...
                onClick={() => {
                  ...
                  setInfoFor(infoConfirmFor);
                  setInfoConfirmFor(null);
                }}
                style={{
                  padding: "12px 0",
                  borderRadius: 10,
      ...
      {/* ── Info viewer modal (descripción + video) ── */}
      {infoFor &&
        (() => {
