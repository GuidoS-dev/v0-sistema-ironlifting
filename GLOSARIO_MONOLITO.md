...
| 33             | **APP_VERSION**                             | Constante `"1.0.10"` — se muestra en pantallas de carga y footer del login                                                                                                                                                                                           |
...
| `APP_VERSION`        | 33    | `"1.0.10"` — versión de la app, se muestra en loading y login                                                                                                                                                         |
