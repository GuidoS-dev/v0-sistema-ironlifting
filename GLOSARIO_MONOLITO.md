...
| 33             | **APP_VERSION**                              | `"1.6.0"` — se muestra en loading screens y footer del login                                                                                                                                                                                                                                                                                                                                    |
...
| `TabataConfig.tsx`              | ConfigRow con +/- para work/rest/rounds/countdown. Toggle sonido. Prop `showRounds` controla visibilidad de rounds row                                                                                                                                                                                                                  |
