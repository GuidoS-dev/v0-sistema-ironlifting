...
| 33             | **APP_VERSION**                             | Constante `"1.0.11"` — se muestra en pantallas de carga y footer del login                                                                                                                                                                                          |
...
| `APP_VERSION`        | 33    | `"1.0.11"` — versión de la app, se muestra en loading y login                                                                                                                                                        |
