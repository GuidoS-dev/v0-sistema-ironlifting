...
function EjCelda({ ej, num, onChange, onRemove, canRemove }) {
  ...
  return (
    <div style={{
      display:"grid",
      gridTemplateColumns:"14px 1fr 38px 28px 14px",
            ...
            <tr>
              ...
              {semanas.map(s=>(
                <th key={s.id} style={{
                  ...
                  <div style={{
                    display:"grid", gridTemplateColumns:"14px 1fr 38px 28px 14px",
    ...
    <div style={{
      ...
      <div style={{width:"100%", maxWidth:400}}>
        ...
        <div style={{textAlign:"center", marginBottom:32}}>
          <div style={{display:"flex",justifyContent:"center"}}><LogoHorizontal height={60}/></div>
          <div style={{fontFamily:"'Bebas Neue'",fontSize:13,color:"var(--muted)",
